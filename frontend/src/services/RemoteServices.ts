...
export default class RemoteServices {
  ...
  // Criar uma sugestão de acividade
  static async createActivitySuggestion(institutionId: number | null, activitySuggestion: ActivitySuggestion): Promise<ActivitySuggestion> {
    return httpClient
  ...
  // Obter a lista de sugestões pelo voluntário
  static async getActivitySuggestionsByVolunteer(): Promise<ActivitySuggestion[]> {
    return httpClient
  ...
  // Obter a lista de sugestões pela instituição
  static async getActivitySuggestionsByInstitution(institutionId: number | null): Promise<ActivitySuggestion[]> {
    return httpClient
  ...
  static async approveActivitySuggestion(activitySuggestionId: number) {
    return httpClient
      .put(`/activitySuggestions/${activitySuggestionId}/approve`)
      .then((response) => {
        return new ActivitySuggestion(response.data);
      })
      .catch(async (error) => {
  ...
  static async rejectActivitySuggestion(activitySuggestionId: number) {
    return httpClient
      .put(`/activitySuggestions/${activitySuggestionId}/reject`)
      .then((response) => {
        return new ActivitySuggestion(response.data);
      })
      .catch(async (error) => {
  ...
  static async createVolunteerProfile(profile: VolunteerProfile) {
    return httpClient
  ...
  static async getVolunteerProfile(
    ...
    return httpClient.get(`/profile/volunteer/${volunteerId}`)
      .then((response) => {
        return new VolunteerProfile(response.data);
      })
      .catch(async (error) => {
