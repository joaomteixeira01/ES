...
public class ActivitySuggestionService {
    ...
    public ActivitySuggestionDto approveActivitySuggestion(Integer activitySuggestionId) {
        ...
        ActivitySuggestion activitySuggestion = activitySuggestionRepository.findById(activitySuggestionId)
                .orElseThrow(() -> new HEException(ACTIVITY_SUGGESTION_NOT_FOUND));
    
        if (activitySuggestion.getState() == ActivitySuggestion.State.APPROVED) {
            throw new HEException(ACTIVITY_SUGGESTION_ALREADY_APPROVED);
        } 
    ...
    public ActivitySuggestionDto rejectActivitySuggestion(Integer activitySuggestionId) {
        ...
        if (activitySuggestion.getState() == ActivitySuggestion.State.REJECTED) {
            throw new HEException(ACTIVITY_SUGGESTION_ALREADY_REJECTED);
        }
