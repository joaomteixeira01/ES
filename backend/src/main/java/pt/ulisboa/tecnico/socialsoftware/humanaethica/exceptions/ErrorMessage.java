...
public enum ErrorMessage {
    ...
    ACTIVITY_SUGGESTION_ALREADY_APPROVED("Activity Suggestion is already approved"),
    ACTIVITY_SUGGESTION_ALREADY_REJECTED("Activity Suggestion is already rejected"),
